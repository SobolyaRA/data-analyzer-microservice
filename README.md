...
from [Data generator service](https://github.com/SobolyaRA/data-generator-microservice)
with Apache Kafka.

Next, data is processed
by [Data store service](https://github.com/SobolyaRA/data-store-microservice).
